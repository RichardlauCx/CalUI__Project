...
//		btnOpPlus.setBounds(236, 200, 60, 95);  // 设置按钮边界范围
//		frame.getContentPane().add(btnOpPlus);  // 将内容窗格中添加按钮
		...
		//		btnNum1.setBounds(14, 308, 60, 41);  // 设置界限范围
		//		frame.getContentPane().add(btnNum1);  // 获得内容窗格并添加到按键当中
				gbc_btnNum1.gridx = 0;
				gbc_btnNum1.gridy = 1;
		...
		btnNum5.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				num[i] = num[i] * 10 + 5;  
				operand = false;
//				num[i] *= 10 + 5;  // 实践证明可以这样操作，但是当被赋值数为0时不成立
			}
		});
		...
		gbc_btnNum4.gridy = 2;  // 网格纵向坐标为gridy
		...
		//		frame.getContentPane().add(btnClear);  // 添加按钮到窗格当中
...
//							System.out.print("\n-Test:" + sum);
			...
			//		frame.getContentPane().add(btnOpEqual);  // 将等于按钮添加到内容窗格当中  
